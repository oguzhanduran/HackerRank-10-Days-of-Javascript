...
// JS
const ids = [1, 2, 3, 6, 9, 8, 7, 4]; //  Sayıların 1'den başlayıp saat yönünde yazılmış ilk hali saat yönünde hareket ettirirken bu diziyi baz alacağız.
let nums = [1, 2, 3, 6, 9, 8, 7, 4]; // saat yönünde döndüreceğimiz dizi.
...
// AllCollection<!-- Enter your HTML code here -->
// <!DOCTYPE html>
// <html>
//     <head>
